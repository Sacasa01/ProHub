...
$magazine = $manager->getMagazines();
$totalMagazine = count($magazine);
$magazinePerPage = 3;
$totalPages = ceil($totalMagazine / $magazinePerPage);

$page = isset($_GET['page']) ? (int)$_GET['page'] : 1;
$page = max(1, min($page, $totalMagazine));

$startIndex = ($page - 1) * $magazinePerPage;
$magazineToShow = array_slice($magazine, $startIndex, $magazinePerPage);
